...
# Training data
parser.add_argument('--data_dir', default='data/KITTI/kitti_2015/data_scene_flow',#KITTI/kitti_2012/data_stereo_flow
                    type=str, help='Training dataset')
parser.add_argument('--dataset_name', default='KITTI2015', type=str, help='Dataset name')

parser.add_argument('--batch_size', default=1, type=int, help='Batch size for inference')
parser.add_argument('--num_workers', default=0, type=int, help='Number of workers for data loading')
parser.add_argument('--img_height', default=384, type=int, help='Image height for inference')
parser.add_argument('--img_width', default=1248, type=int, help='Image width for inference')

# Model
parser.add_argument('--seed', default=326, type=int, help='Random seed for reproducibility')
parser.add_argument('--output_dir', default='output/kit15_val', type=str,
...
parser.add_argument('--pretrained_aanet', default='checkpoints/newnet_bg_sceneflow/aanet_best.pth', type=str, help='Pretrained network')
...
parser.add_argument('--num_images', default=40, type=int, help='Number of images for inference')
...
def main():
    ...
    if os.path.exists(args.pretrained_aanet):
        ...
        utils.load_pretrained_net(fastnet, args.pretrained_aanet, no_strict=True)
    else:
    ...
    if torch.cuda.device_count() > 1:
        ...
        aanet = torch.nn.DataParallel(fastnet)
    ...
    for i, sample in enumerate(test_loader):
        ...
        with torch.no_grad():
            ...
            pred_disp = fastnet(left, right)[-1]  # [B, H, W]
