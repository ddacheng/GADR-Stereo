...
# Training data
parser.add_argument('--data_dir', default='data/KITTI/KITTI2012', type=str, help='Training dataset')
parser.add_argument('--dataset_name', default='KITTI2012', type=str, help='Dataset name')

parser.add_argument('--batch_size', default=1, type=int, help='Batch size for training')
parser.add_argument('--val_batch_size', default=1, type=int, help='Batch size for validation')
parser.add_argument('--num_workers', default=0, type=int, help='Number of workers for data loading')
parser.add_argument('--img_height', default=256, type=int, help='Image height for training')
parser.add_argument('--img_width', default=576, type=int, help='Image width for training')
...
parser.add_argument('--checkpoints_dir', default='checkpoints/net_kitti15', type=str, help='Directory to save model checkpoints and logs')
...
parser.add_argument('--pretrained_aanet', default=None, type=str, help='Pretrained network')#'checkpoints/aanet_sceneflow/aanet_best.pth'
...
parser.add_argument('--no_validate', action='store_false', help='No validation')
...
def main():
    ...
    fastnet = nets.FastNet(args.max_disp,
                       ...
                       no_intermediate_supervision=args.no_intermediate_supervision).to(device)
