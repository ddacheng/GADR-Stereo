...
parser.add_argument('--checkpoints_dir', default='checkpoints/stereonet_sceneflow', type=str, help='Directory to save model checkpoints and logs')
parser.add_argument('--learning_rate', default=1e-3, type=float, help='Learning rate')
parser.add_argument('--weight_decay', default=1e-4, type=float, help='Weight decay for optimizer')
parser.add_argument('--max_disp', default=192, type=int, help='Max disparity')
parser.add_argument('--max_epoch', default=36, type=int, help='Maximum epoch number for training')
...
parser.add_argument('--milestones', default='10,16,22,28,34', type=str, help='Milestones for MultiStepLR')
