...
parser.add_argument('--data_dir', default='data/input',  type=str, help='Data directory for prediction')

parser.add_argument('--num_workers', default=0, type=int, help='Number of workers for data loading')
parser.add_argument('--img_height', default=1242, type=int, help='Image height for inference')
parser.add_argument('--img_width', default=375, type=int, help='Image width for inference')

# Model
parser.add_argument('--seed', default=326, type=int, help='Random seed for reproducibility')
parser.add_argument('--output_dir', default='data_predictions/output', type=str,
...
parser.add_argument('--pretrained_aanet', default='checkpoints/newnet_kit15/aanet_latest.pth', type=str, help='Pretrained network')
...
parser.add_argument('--num_images',default=50,type=int,help='number of images for inference')
...
def main():
    ...
    if os.path.exists(args.pretrained_aanet):
        print('=> Loading pretrained FastNet:', args.pretrained_aanet)
    ...
    for i, sample_name in enumerate(all_samples):
        if args.count_time and i==args.num_iamges:  #testing time only
            break
