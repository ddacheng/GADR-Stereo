...
# Training data
parser.add_argument('--data_dir', default='data/SceneFlow',#KITTI/kitti_2012/data_stereo_flow
...
parser.add_argument('--output_dir', default='output/sceneflow2_val', type=str,
...
parser.add_argument('--pretrained_aanet', default='checkpoints/newnet_sceneflow2/aanet_best.pth', type=str, help='Pretrained network')
...
parser.add_argument('--num_images', default=512, type=int, help='Number of images for inference')
